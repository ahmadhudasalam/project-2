    ...
    <section class="content">
      ...
      <div class="card  card-success card-outline collapsed-card">
        <div class="card-header">
          <h3 class="card-title"><strong>Aplikasi Info Fasilitas Kesehatan Kota Depok</strong></h3>
        ...
        <div class="card-body">
          <ol class="list-group list-group-light border-danger">
            <li class="list-group-item">
              <strong>Ahmad Huda Salam - 0110221238</strong>
            </li>
            <li class="list-group-item">
              <strong>Muhammad Faris - 0110221247</strong>
            </li>
            <li class="list-group-item">
              <strong>Muhammad Rijal Jiddan - 0110221246</strong>
            </li>
            <li class="list-group-item">
              <strong>Virgin Zahra Kuswandi - 0110221249</strong>
            </li>
          </ol>
        </div>
        <!-- /.card-body -->
