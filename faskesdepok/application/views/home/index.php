  ...
  <header id="header-wrap">
    ...
    <nav class="navbar navbar-expand-md bg-inverse fixed-top scrolling-navbar">
      <div class="container">
        ...
        <a href="#" class="navbar-brand text-danger">FasKesDepok</a>
        ...
        <div class="col-lg-12 col-md-12 col-xs-12">
          ...
          <?php foreach ($list_faskes as $faskes) { ?>
            <div class="team-item wow fadeInRight" data-wow-delay="0.2s">
              <div class="team-img">
                <img class="img-fluid" src="<?php echo base_url() . '/dist/img/' . $faskes->foto2 ?>" alt="">
              </div>
              <div class="contetn">
                <div class="info-text">
                  ...
                  <?php if ($this->session->has_userdata('ID')) { ?>
                    <a href="<?php echo base_url('index.php/home/insert?idfaskes=' . $faskes->id) ?>" class="btn btn-danger">Beri Nilai</a>
                  <?php } else {
                  } ?>
                </div>
              </div>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="copyright-content">
              <p> <a rel="nofollow" href="https://github.com/ahmadhudasalam/project-2" target="_blank">Project 2 Pemrograman Web</a> Faskes Depok</p>
            </div>
          </div>
        </div>
      </div>
